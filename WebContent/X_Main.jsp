<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="com.member.MemberService, com.util.*"%>
...
<c:set var="ms" value="<%=new MemberService() %>" />
		...
		<div class='main'>
			...
			<div class="main__content">
				...
				<div class='right-side'>
					<div class='greathall'
						onclick="location.href='./palace/Palace.jsp'">왕궁</div>
